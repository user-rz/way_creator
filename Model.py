...
class Route:
    ...
    def __init__(self, name, routes):
        """
        Маршрут имеет имя name.
        Словарь bus_stops: ключ - название остановки, значение - время прибытия на остановку.
        Список названий остановок list_of_bus_stops.
        Словарь bus_changes: ключ - название остановки-пересадки,
        значение - название маршрута, на который можно пересесть.
        """
    ...
    def set_bus_change(self, change, another_route):
        """
        Добавляет пересадку в словарь bus_changes.
